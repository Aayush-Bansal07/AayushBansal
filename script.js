...
document.addEventListener("DOMContentLoaded", () => {
  const serviceCards = Array.from(document.querySelectorAll(".services__grid .card"));

  const floatingTarget = document.getElementById("floating-lines");
  initFloatingLines(floatingTarget, {
    enabledWaves: ["top", "middle", "bottom"],
    lineCount: 6,
    lineDistance: 12,
    bendRadius: 3,
    ...
    parallax: true,
    animationSpeed: 0.8,
    linesGradient: ["#ec4899", "#a855f7", "#8b5cf6", "#06b6d4", "#22d3ee", "#67e8f9"],
  });
